...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding unique constraint on 'SiteGroup', fields ['group']
        db.create_unique('sitepermissions_sitegroup', ['group_id'])
    
    
    def backwards(self, orm):
        
        # Removing unique constraint on 'SiteGroup', fields ['group']
        db.delete_unique('sitepermissions_sitegroup', ['group_id'])
